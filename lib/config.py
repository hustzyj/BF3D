...
__C.LI_FUSION.ADD_Image_Attention = True
...
__C.RPN.SA_CONFIG.sample_method = [['D-FPS'], ['D-FPS'], ['cls'], ['cls']]
__C.RPN.SA_CONFIG.CONFIDENCE_MLPS = [[64], [128], [256], []]
__C.RPN.SA_CONFIG.RADIUS = [[0.1, 0.5], [0.5, 1.0], [1.0, 2.0], [2.0, 4.0]]
__C.RPN.SA_CONFIG.NSAMPLE = [[16, 32], [16, 32], [16, 32], [16, 32]]
__C.RPN.SA_CONFIG.NSAMPLE_qurry = [[1, 2], [1, 2], [1, 2], [1, 2]]
...
__C.RCNN.SA_CONFIG.MLPS = [[128, 128, 128],
                           [128, 128, 256],
                           [256, 256, 512]]
__C.RCNN.CLS_FC = [512, 512]
__C.RCNN.REG_FC = [512, 512]
