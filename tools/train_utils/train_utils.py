...
class Trainer(object):
    ...
    # def _train_it(self, batch):
        ...
        ##################
        # loss, tb_dict, disp_dict = self.model_fn(self.model, batch, T_model)
    ...
    def train(self, start_it, start_epoch, n_epochs, train_loader, test_loader = None, ckpt_save_interval = 5,
        ...
        sample_loss_list = []
        # sample_all = {}
        # sample_all['SA1'] = sample_all['SA2'] = sample_all['SA3'] = sample_all['SA4'] = 0
        with tqdm.trange(start_epoch, n_epochs, desc = 'epochs') as tbar, \
            ...
            for epoch in tbar:
                ...
                for cur_it, batch in enumerate(train_loader):
                    ...
                    ######################
                    # sample_loss = disp_dict['sample_loss']
                    # sample_all['SA1'] += sample_dic['SA1']
                    # sample_all['SA2'] += sample_dic['SA2']
                    # sample_all['SA3'] += sample_dic['SA3']
                    # sample_all['SA4'] += sample_dic['SA4']
                    # if sample_loss<80:
                    #    sample_loss_list.append(disp_dict['sample_loss'])
                ...
                #     w.write(str(sample_all['SA1']//840) + '/')
                #     w.write(str(sample_all['SA2']//840) + '/')
                #     w.write(str(sample_all['SA3']//840) + '/')
                #     w.write(str(sample_all['SA4']//840) + '/')
